...
function chooseColor(price) {
    if (price > 1000) return "#FF0000"; // red
    else if (price > 800) return "#FF6600"; // dark orange
    else if (price > 600) return "#FFCC00"; // orange
    else if (price > 400) return "#FFFF00"; // yellow
    else if (price > 200) return "#CCFF00"; // yellowish green
    else return "#00FF00"; // light green
}

// Create layers for subway, heatmap, and neighborhoods
